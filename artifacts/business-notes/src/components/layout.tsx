...
import { BookOpen, ChevronRight, Moon, Sun, Library } from "lucide-react";
      ...
      <aside className="fixed top-0 left-0 z-30 hidden h-screen w-64 flex-col border-r border-border bg-sidebar md:flex">
        ...
        <ScrollArea className="flex-1 py-4">
          <div className="px-4 mb-2">
            <h2 className="text-xs font-bold tracking-wider text-muted-foreground uppercase">Unit 1</h2>
          </div>
